...
export function Dash(){
    ...
    const [loader,setLoader]=useState<boolean>(true)
     useEffect(()=>{
         axios.get("https://docs-clone-c3.onrender.com/api/v1/getdocswithconnecteduser", {
    ...
    return(
        ...
        <div className=" h-max flex items-center justify-center max-[480px]:flex  max-[480px]:flex-col">
            <div className="text-start mx-2">
              ...
              const response= await axios.get("https://docs-clone-c3.onrender.com/api/v1/createDoc",{
                    withCredentials:true
                })
